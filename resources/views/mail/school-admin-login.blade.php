                    ...
                    <tr>
                        <td style="padding:24px;">
                            ...
                            <div style="margin:20px 0;padding:14px;border:1px solid #fde68a;background:#fffbeb;border-radius:12px;color:#78350f;">
                                <strong>Welcome wallet credit:</strong> Complete onboarding to claim your &#8358;5,000 SchoolProfit Plus wallet credit.
                            ...
                            <p style="font-size:13px;color:#64748b;margin-bottom:0;">If you did not expect this account, please contact the SchoolProfit administrator.</p>
                        </td>
                    </tr>
                </table>
            </td>
