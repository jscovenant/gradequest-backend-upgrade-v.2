...
<head>
    <meta charset="utf-8">
    <title>Platform Staff Login</title>
</head>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width:620px;background:#ffffff;border:1px solid #e5e7eb;border-radius:14px;overflow:hidden;">
                    <tr>
                        <td style="background:#111827;color:#ffffff;padding:24px;">
                            <h1 style="margin:0;font-size:22px;">Welcome to SchoolProfit</h1>
                    ...
                    <tr>
                        <td style="padding:24px;">
                            ...
                            <p>You can now log in to your SchoolProfit platform dashboard using the details below.</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin:20px 0;border-collapse:collapse;">
                                ...
                                <tr>
                                    <td style="padding:10px;border:1px solid #e5e7eb;background:#f8fafc;font-weight:bold;">Access Type</td>
                                    <td style="padding:10px;border:1px solid #e5e7eb;">{{ $user->superAdminTypeLabel() }}</td>
                                </tr>
                                <tr>
                            ...
                            <p style="font-size:13px;color:#64748b;margin-bottom:0;">If you did not expect this account, please contact the SchoolProfit CEO or platform owner.</p>
                        </td>
                    </tr>
                </table>
            </td>
